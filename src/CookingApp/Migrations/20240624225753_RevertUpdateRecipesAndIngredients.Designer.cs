...
namespace CookingApp.Migrations
{
    ...
    [Migration("20240624225753_RevertUpdateRecipesAndIngredients")]
    partial class RevertUpdateRecipesAndIngredients
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CookingApp.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Password = "$2a$11$y4fUB2bzLZoCqpaOvbVXqOvTR/lwao91Rm2aDDCC0YZlAdq3oujVS",
                            Username = "admin"
                        });
                });
