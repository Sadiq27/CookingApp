...
namespace CookingApp.Migrations
{
    ...
    [Migration("20240624190939_UpdateRecipesAndIngredients")]
    partial class UpdateRecipesAndIngredients
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CookingApp.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Password = "$2a$11$raqZ/3s.7/5XCS7tsIp7vu6OzXbEoFR9v6dY3TF5KN8sIRuiqPwze",
                            Username = "admin"
                        });
                });
